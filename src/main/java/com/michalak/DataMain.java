...
import com.michalak.dao.HibernateDaoImpl;
...
public class DataMain {
	...
	public static void main(String[] args) {
		...
		//No class template standard dao
		...
		//HIBERNATE
		HibernateDaoImpl dao3 = ctx.getBean("hibernateDaoImpl", HibernateDaoImpl.class);
...
//	System.out.println(dao.getAllCircles().size());	//Getting list size from METHOD4
	...
	System.out.println(dao3.getCircleCount());	//Getting list size from  HIBERNATE  HibernateDaoImpl
